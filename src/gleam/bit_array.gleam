...
pub fn from_string(x: String) -> BitArray {
  bit_array_from_string(x)
}

@external(javascript, "../gleam_stdlib.mjs", "bit_array_from_string")
fn bit_array_from_string(x: String) -> BitArray
...
pub fn slice(
  ...
  bit_array_slice(string, position, length)
}
...
pub fn concat(bit_arrays: List(BitArray)) -> BitArray {
  bit_array_concat(bit_arrays)
}

@external(javascript, "../gleam_stdlib.mjs", "bit_array_concat")
fn bit_array_concat(bit_arrays: List(BitArray)) -> BitArray
...
pub fn base64_encode(input: BitArray, padding: Bool) -> String {
  bit_array_base64_encode(input, padding)
}

@external(javascript, "../gleam_stdlib.mjs", "bit_array_encode64")
fn bit_array_base64_encode(input: BitArray, padding: Bool) -> String
...
fn decode64(a: String) -> Result(BitArray, Nil) {
  bit_array_decode64(a)
}

@external(javascript, "../gleam_stdlib.mjs", "bit_array_decode64")
fn bit_array_decode64(a: String) -> Result(BitArray, Nil)
...
pub fn base16_encode(input: BitArray) -> String {
  bit_array_base16_encode(input)
}

@external(javascript, "../gleam_stdlib.mjs", "bit_array_base16_encode")
fn bit_array_base16_encode(input: BitArray) -> String
...
pub fn base16_decode(input: String) -> Result(BitArray, Nil) {
  bit_array_base16_decode(input)
}

@external(javascript, "../gleam_stdlib.mjs", "bit_array_base16_decode")
fn bit_array_base16_decode(input: String) -> Result(BitArray, Nil)
...
pub fn starts_with(bits: BitArray, prefix: BitArray) -> Bool {
  do_starts_with(bits, prefix)
}

@external(javascript, "../gleam_stdlib.mjs", "bit_array_starts_with")
fn do_starts_with(bits: BitArray, prefix: BitArray) -> Bool {
