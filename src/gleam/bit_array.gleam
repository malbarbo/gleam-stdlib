...
pub fn byte_size(x: BitArray) -> Int {
  bit_array_byte_size(x)
}

@external(javascript, "../gleam_stdlib.mjs", "bit_array_byte_size")
fn bit_array_byte_size(x: BitArray) -> Int
...
@external(javascript, "../gleam_stdlib.mjs", "bit_array_base64_encode")
...
@external(javascript, "../gleam_stdlib.mjs", "bit_array_base64_decode")
