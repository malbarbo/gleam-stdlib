...
fn do_crop(from string: String, before substring: String) -> String
...
fn do_contains(does haystack: String, contain needle: String) -> Bool
...
fn do_byte_size(string: String) -> Int
